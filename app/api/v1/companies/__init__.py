...
- company_pipeline: Simplified company pipeline management endpoints
"""
...
from .company_pipeline import router as pipeline_router
...
# org_profile_router, match_config_router, and pipeline_router must come
# before crud_router so that static paths are matched before /{company_id}.
