...
def upgrade() -> None:
    ...
    # COMMENTED OUT: Don't drop notifications table - it's needed by later migrations
...
def downgrade() -> None:
    ...
    op.alter_column('applications', 'status',
               ...
               existing_nullable=False)
    # COMMENTED OUT: Don't recreate notifications table in downgrade since we didn't drop it in upgrade
